...
#Reading csv files
adult.train <- read.csv("adult.csv", header=FALSE, na.strings="?", stringsAsFactors=FALSE)#Load Training Dataset 
adult.train$V14<-as.character(adult.train$V14)
adult.test<-read.table("adult.test",sep = ",",header = FALSE, skip = 1,na.strings = " ?")#Load Testing Dataset
