...
adult_test<-read.csv("adult_test_df.csv")
...
##As we can see from the result above, there is a 84.89% match between observed and predicted values of the dependent variable.
